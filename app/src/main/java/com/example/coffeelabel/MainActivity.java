package com.example.coffeelabel;
...
public class MainActivity extends AppCompatActivity implements ReceiveListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AutoCompleteTextView newExt = (AutoCompleteTextView)findViewById(R.id.spinnerMenu2);
    ...
    private boolean createCouponData() {
        ...
        AutoCompleteTextView spinMenu2 = (AutoCompleteTextView)findViewById(R.id.spinnerMenu2);
        ...
        try {
            ...
            textData.append("   "+singleMenu+"-"+xtra+"\n");
            textData.append("   Selamat Menikmati\n");
            method = "addText";
